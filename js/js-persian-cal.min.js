...
cE("a");e.className=c.btnClassName;e.href="#";d.parentNode.insertBefore(e,d.nextSibling);var g=this;e.onclick=function(a){g.showHidePicker(a);return!1}}var f=this;d.onclick=function(a){f.showHidePicker(a);return!1};var h=this;d.onblur=function(){h.normalizeUserInput()};var k=this;addEvt(d,"keydown",function(a){k.keyDownHandler(a,k)});c.initialDate&&this.fillDateField(c.initialDate)};
